...
public class SDKWithAPIAndWebViewVC: UIViewController {
    ...
    @IBAction func webviewBtnAct(_ sender: UIButton){
        if let vc = storyboard?.instantiateViewController(withIdentifier: "SDKWebViewVC") as? SDKWebViewVC{
...
extension SDKWithAPIAndWebViewVC: UITableViewDataSource, UITableViewDelegate{
